...
const PAGE_DIR = path.join("src", "modules", path.sep);

const htmlPlugins = getFilesFromDir(PAGE_DIR, [".html"]).map((filePath) => {
  const fileName = filePath.replace(PAGE_DIR, "");
  // { chunks:["contact", "vendor"], template: "src/modules/contact.html",  filename: "contact.html"}
...
const entry = getFilesFromDir(PAGE_DIR, [".js", ".jsx", ".ts", ".tsx"]).reduce(
  (obj, filePath) => {
